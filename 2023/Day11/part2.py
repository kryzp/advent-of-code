	...
	for galaxy2 in galaxies:
		...
		for x in range(abs(dx) - 1):
			if is_empty_col(min(galaxy[0], galaxy2[0]) + x + 1):
				dist += 999_999 # i misread the question and implemented a while minimum distance pair matching system. turns out you just set this to 1 million - 1. going to kms.
